...
# =====================================================================================
# Role: Primary orchestrator for the Phoenix Hypervisor system.
# Input:
...
#   - phoenix_lxc_configs.json: Defines specific configurations for LXC containers (resources, network, GPU assignment, roles, AI model details).
#     Path hardcoded to /usr/local/phoenix_hypervisor/etc/phoenix_lxc_configs.json.
# Process: Sequentially processes each LXC container defined in phoenix_lxc_configs.json, executing steps to create/configure based on config_block.
# Execution: Calls dedicated supporting scripts in /usr/local/phoenix_hypervisor/bin/.
# Idempotency: Designed to be re-run; checks existence/state before creating/configuring.
# Error Handling: Basic error checking (exit codes) and logging. May perform simple rollback. Continues unless critical failure.
# Output: Configured LXC containers as defined, with log output.
# Environment: Assumes standard Proxmox VE. Relies on jq, pct, bash, ajv-cli.
#
# =====================================================================================
